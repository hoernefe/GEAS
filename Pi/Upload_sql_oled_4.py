...
mydb = mysql.connector.connect(
  host="mysql.webhosting51.1blu.de",
  user="s138563_3123585",
  password="%plMqnnJ2guI9X1",
  database="db138563x3123585"
)
...
def wetterdaten():
    ...
    response=urllib.urlopen("http://api.openweathermap.org/data/2.5/weather?appid=ae1e2dc3e5f0be4682d8424589fbe604&q=Karlsruhe")
